...
return [
    ...
    'client' => [
        ...
        'captcha_rate_limited' => 'Too many verification requests. Please retry in :seconds seconds.',
        'captcha_network_error' => 'Unable to load verification. Please try again later.',
    ...
    'unlock_succeeded' => 'Unlocked successfully',
    'unlock_confirm' => 'Confirm operation?',
    ...
    'collapse'              => 'Collapse',
    'sidebar'               => 'Sidebar',
    'expand_sidebar_title'  => 'Expand :title',
    'collapse_sidebar'      => 'Collapse sidebar',
    'expand_filter_sidebar' => 'Expand filter sidebar',
    'collapse_filter_sidebar' => 'Collapse filter sidebar',
    'search_keyword_placeholder' => 'Enter keywords to search',
    'filter'                => 'Filter',
    'search'                => 'Search',
    'close'                 => 'Close',
    'show'                  => 'Show',
    ...
    "en" => "English",
    "vi" => "Vietnamese",
    "manager_admin_title" => "Admin System",
    "merchant_admin_title" => "Merchant System",
    "agent_admin_title" => "Agent System",
    ...
    "yypay" => "Y&Y",
    'phpay' => 'PHPAY',
    "thuyphatpay" => "THUYPHATPAY",
    "laicaipay" => "LaicaiPay",
    "nnpay" => "NNPAY",
    "huiqianjinpay" => "Huiqianjin",
    "kwpay" => "KWPAY",
    "apay" => "APAY",
    "tp88pay" => "TP88PAY",
];
