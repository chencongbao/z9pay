...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::table('merchant_channels', function (Blueprint $table) {
            ...
            $table->string("settlement_time")->nullable()->default("17:00:00")->comment("结算时间");
        });
    }
    ...
    {
        Schema::table('merchant_channels', function (Blueprint $table) {
            if (Schema::hasColumn('merchant_channels', 'settlement_mode')) {
                $table->dropColumn('settlement_mode');
            }
            if (Schema::hasColumn('merchant_channels', 'settlement_time')) {
