...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('merchant_trade_logs', function (Blueprint $table) {
            $table->id();
            ...
            $table->decimal("freeze_amount",20,2)->default(0)->comment("结算中金额");
    ...
    {
        Schema::dropIfExists('merchant_trade_logs');
    }
};
