...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('report_merchant_agents', function (Blueprint $table) {
            $table->id();
            ...
            $table->decimal("settlement_commission",30,2)->default(0)->comment("代付佣金");
            ...
            $table->integer("settlement_order_number_total")->default(0)->comment("总单数，成功");
            ...
            $table->decimal("settlement_order_total_amount",30,2)->default(0)->comment("代付总跑量，成功");
    ...
    {
        Schema::dropIfExists('report_merchant_agents');
    }
};
