...
return new class extends Migration
{
    ...
    {
        Schema::table('transfer_orders', function (Blueprint $table) {
            if (Schema::hasColumn('transfer_orders', 'user_agent3_commission')) {
                $table->dropColumn('user_agent3_commission');
            }
            if (Schema::hasColumn('transfer_orders', 'user_agent3_rate')) {
                $table->dropColumn('user_agent3_rate');
            }
            if (Schema::hasColumn('transfer_orders', 'user_agent3_id')) {
