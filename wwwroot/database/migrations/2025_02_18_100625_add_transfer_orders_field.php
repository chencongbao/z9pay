...
return new class extends Migration
{
    ...
    {
        Schema::table('transfer_orders', function (Blueprint $table) {
            if (Schema::hasColumn('transfer_orders', 'merchant_agent3_id')) {
                $table->dropColumn('merchant_agent3_id');
            }
            if (Schema::hasColumn('transfer_orders', 'merchant_agent3_rate')) {
                $table->dropColumn('merchant_agent3_rate');
            }
            if (Schema::hasColumn('transfer_orders', 'merchant_agent3_commission')) {
