...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('report_channel_merchants', function (Blueprint $table) {
            $table->id();

            $table->date("date_add")->nullable()->index()->comment("统计日期");
            $table->integer("mid")->default(0)->index()->comment("商户ID");
            $table->integer("cid")->default(0)->index()->comment("渠道ID");
    ...
    {
        Schema::dropIfExists('report_channel_merchants');
    }
};
