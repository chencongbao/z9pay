(function (window) {
    ...
    var StickyTableHeader = /** @class */ (function () {
        ...
        StickyTableHeader.prototype.getScrollParents = function (node, direction) {
            var parents = [];
        ...
        StickyTableHeader.prototype.setupClickEventMirroring = function () {
            ...
            this.clickListener = function (event) {
                ...
                scrollParents.forEach(function (p) {
                    p._save_scroll = 'scrollY' in p ? p.scrollY : p.scrollTop;
                });

                _this.header.style.scrollMarginTop = "".concat(_this.getTop() + 3, "px");
                _this.header.scrollIntoView({ behavior: 'instant', block: 'start' });
                ...
                do {
                    ...
                    if (target && !_this.header.contains(target)) {
                        target.style.visibility = 'collapse';
                        hiddenTargets.push(target);
                    }
                } while (target && !_this.header.contains(target) && hiddenTargets.length < 10);
                ...
                hiddenTargets.forEach(function (t) {
                    return t.style.removeProperty('visibility');
                });

                scrollParents.forEach(function (p) {
                    return p.scrollTo({ behavior: 'instant', top: p._save_scroll });
                });
            };
        ...
        StickyTableHeader.prototype.setHorizontalScrollOnClone = function () {
            this.cloneContainerParent.style.width = "".concat(this.horizontalScrollContainer.getBoundingClientRect().width, "px");
        ...
        StickyTableHeader.prototype.getTop = function () {
            ...
            var parentTops = this.scrollParents.map(function (c) {
    ...
    window.VhStickyTableHeader = StickyTableHeader;
})(window);
