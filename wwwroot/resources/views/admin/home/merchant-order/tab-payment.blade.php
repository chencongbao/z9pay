...
<ul class="list-group list-group-flush">
    ...
    <a class="list-group-item search-payment-item @if(\Illuminate\Support\Facades\Request::input('payment_id') == $item['id'])active @endif" href="{{\Dcat\Admin\Admin::app()->getRoute("today.index",['payment_id'=>$item['id']])}}#tab_payment">【#{{$item['id']}}】{{$item['name']}}</a>
    @endforeach
</ul>
<style>
    .search1 {
