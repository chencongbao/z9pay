<div class="row">
    <div class="col-3">
        <div class="home-title">今日充值订单</div>
    ...
    <div class="col-3">
        <div class="home-title">今日充值总额</div>
    ...
    <div class="col-3">
        <div class="home-title">今日代付/提现订单</div>
    ...
    <div class="col-3">
        <div class="home-title">今日代付/提现总额</div>
        <div class="home-block">
            {{bob_amount_format($today_transfer_amount)}}
            <em class="home-unit">CNY</em>
        </div>
    </div>
</div>
