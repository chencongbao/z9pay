    ...
    <div class="pkr-page">
        <div class="pkr-shell">
            ...
            <section v-if="showPayWaiting" class="waiting-card">
                ...
                <p>Please open JazzCash App and complete the payment before the countdown ends.</p>
                <p class="urdu">براہ کرم JazzCash App کھولیں اور الٹی گنتی ختم ہونے سے پہلے ادائیگی مکمل کریں۔</p>
            ...
            <van-form v-else class="payment-form" @submit="onSubmit">
                <section class="method-section">
                    ...
                    <button class="method-card" type="button" aria-label="JazzCash">
                        <img class="method-logo" src="@/img/pkr/jazzcash.png" alt="JazzCash" />
                    </button>
                </section>
