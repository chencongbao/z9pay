    ...
    <div class="pg">
        ...
        <div class="top">
            <div class="top-inner">
                ...
                <div class="top-right">
                    <div class="logo">
                        <img class="logo-img" src="@/img/vnd/thuyphat.webp" alt="THUYPHATPAY" />
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="dash dash-big">
                    <div class="grid">
                        ...
                        <div class="col col-qr">
                            ...
                            <div class="brand">
                                <img class="brand-img" src="@/img/vnd/thuyphat.webp" alt="THUYPHATPAY" />
                            </div>

                            <!-- 二维码：先用占位点阵（你有真实二维码图片再替换） -->
                            <div class="qr">
                                <div class="qr-fake">
                                    <img class="qr-img" :src="info.collection_qrcode" alt="THUYPHATPAY" v-if="info.collection_qrcode"/>
                                </div>
                            </div>
