# @lang('apidoc.docs.transfers.query.title')

### @lang('apidoc.docs.deposits.index.t1')

- <p>https://{@lang('apidoc.docs.deposits.index.s1')}/api/v3/transfers/query</p>
...
| &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;fail_reason   | String                                 | @lang('apidoc.docs.deposits.index.s8') | @lang('apidoc.api.fail_reason')                                                                                                                   |
