...
| bank_code | String | @lang('apidoc.docs.deposits.index.s7') | @lang('apidoc.docs.currency.fixed_ob') |
| bank_name | String | @lang('apidoc.docs.deposits.index.s7') | @lang('apidoc.docs.currency.india_bank_name') |
| bank_branch | String | @lang('apidoc.docs.deposits.index.s7') | @lang('apidoc.docs.currency.india_ifsc') |
| card_no | String | @lang('apidoc.docs.deposits.index.s7') | @lang('apidoc.docs.currency.bank_card_no') |
...
## @lang('apidoc.docs.currency.india_upi_title')

### @lang('apidoc.docs.currency.full_params_extra')

| @lang('apidoc.docs.deposits.index.s2') | @lang('apidoc.docs.deposits.index.s5') |
| --- | --- |
| bank_code | @lang('apidoc.docs.currency.fixed_ob') |
| bank_name | @lang('apidoc.docs.currency.fixed_upi') |
| bank_branch | @lang('apidoc.docs.currency.random_value') |
| card_no | @lang('apidoc.docs.currency.upi_account') |
| holder_name | @lang('apidoc.docs.currency.random_value') |
