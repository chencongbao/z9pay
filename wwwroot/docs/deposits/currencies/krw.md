...
| bank_name | String | @lang('apidoc.docs.deposits.index.s7') | @lang('apidoc.docs.currency.bank_name') |
| card_no | String | @lang('apidoc.docs.deposits.index.s7') | @lang('apidoc.docs.currency.bank_card_no') |
| card_name | String | @lang('apidoc.docs.deposits.index.s7') | @lang('apidoc.api.card_name') |
