...
return [
    ...
    |
    */
    'lang_key' => env('ADMIN_LANG_KEY', env('APP_NAME', 'luckypay')),

    'name' => env('ADMIN_NAME',"远方支付"),
    /*
    |--------------------------------------------------------------------------
    | dcat-admin logo
    |--------------------------------------------------------------------------
    ...
    */
    'route' => [
        ...
        'middleware' => ['web', 'admin','set.lang','merchant.config',"check.admin.user.status"],
   ...
   */
    ...
    */
    'auth' => [
        ...
        'providers' => [
            'admin' => [
                'driver' => 'eloquent',
                'model'  => App\Models\AdminAdministrator::class,
            ],
        ],
    ...
    */
    'database' => [
        ...
        'users_model' => App\Models\AdminAdministrator::class,
    ...
    */
    'extension' => [
        ...
        'dir' => base_path('public/vendor/dcat-admin-extensions'),
    ],
