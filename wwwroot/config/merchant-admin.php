...
return [
    ...
    |
    */
    'lang_key' => env('MERCHANT_ADMIN_LANG_KEY', env('ADMIN_LANG_KEY', env('APP_NAME', 'luckypay'))),

    'name' => env('MERCHANT_ADMIN_NAME', env('ADMIN_NAME', '远方支付')),
    ...
    |
    */
    'logo' => env('MERCHANT_ADMIN_LOGO', env('ADMIN_LOGO', env('ADMIN_NAME', '远方支付'))),
    ...
    |
    */
    'logo-mini' => env('MERCHANT_ADMIN_LOGO', env('ADMIN_LOGO', env('ADMIN_NAME', '远方支付'))),
    ...
    */
    'route' => [
        'domain' => env('MERCHANT_ADMIN_ROUTE_DOMAIN'),

        'prefix' => env('MERCHANT_ADMIN_ROUTE_PREFIX', 'merchant-admin'),

        'namespace' => 'App\\MerchantAdmin\\Controllers',

        'middleware' => ['merchant.admin.security.headers', 'web', 'normalize.merchant.grid.pagination', 'normalize.merchant.grid.query', 'admin','set.lang','merchant.config','check.merchant.user.status'],
    ],
    ...
    |
    */
    'directory' => app_path('MerchantAdmin'),
    ...
    |
    */
    'title' => env('MERCHANT_ADMIN_NAME', env('ADMIN_NAME', '远方支付')),
   ...
   */
    ...
    */
    'auth' => [
        ...
        'controller' => App\MerchantAdmin\Controllers\AuthController::class,
    ...
    */
    'grid' => [
        ...
        'request_rules' => [
            'deposit-orders' => [
                'string' => ['ordernumber', 'order_no', 'pay_name'],
                'int' => ['status', 'payment_id'],
                'decimal' => ['amount_min', 'amount_max'],
                'range' => ['created_at', 'success_time'],
                'sort' => ['id'],
            ],
            'transfer-orders' => [
                'string' => ['ordernumber', 'order_no', 'holder_name'],
                'int' => ['status'],
                'range' => ['created_at', 'success_time'],
                'sort' => ['id'],
            ],
        ...
        'paginator_class' => App\Extendtions\Dcat\Grid\Tools\Paginator::class,
    ...
    */
    'database' => [
        ...
        'users_model' => \App\Models\MerchantUser::class,
