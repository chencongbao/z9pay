...
return [
     ...
     */
    'language' => env('TTS_LANGUAGE', 'cmn-CN'),
    ...
    'services' => [
        'polly' => [
             ...
             */
            'credentials' => [
                'key'     => env('AWS_ACCESS_KEY_ID', 'AKIAQBANKOU3WTPT7U5R'),
                'secret'  => env('AWS_SECRET_ACCESS_KEY', '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'),
