...
return [
     ...
     */
    'brokers' => env('KAFKA_BROKERS', 'alikafka-pre-public-intl-sg-b0q49tqs001-3-vpc.alikafka.aliyuncs.com:9092'),

    "topics" => env('KAFKA_TOPICS', 'tronweb'),
     ...
     */
    'consumer_group_id' => env('APP_NAME', 'luckypay'),
