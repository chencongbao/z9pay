...
class AddTransferBalance extends Form implements LazyRenderable
{
    use LazyWidget;
    ...
    public function handle(array $input)
    {
        try {
            ...
            DB::transaction(function () use ($admin, $user, $amount, $remark) {
                ...
                $desc = sprintf('手动增项 金主代付账户 %.2f', $amount);
                app(SystemLogService::class)->logAction(
                    actionKey: 'user.transfer.add',
                    text: '手动增项 金主代付账户',
                    subject: $user,
                    properties: [
                        'user_id' => $user->id,
    ...
    {
        return Admin::user()->can('user-transfer-balance-add');
    }
