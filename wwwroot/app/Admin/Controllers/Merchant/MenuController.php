...
use App\Repositories\MerchantMenu;
...
class MenuController extends AdminController
{
        ...
        return $content
            ...
            ->body(function (Row $row) {
                ...
                $row->column(5, function (Column $column) {
                    $form = new WidgetForm();
                    $form->action(admin_url('merchant/auth/menu'));
        ...
        return new Tree(new $menuModel(), function (Tree $tree) {
            ...
            $tree->branch(function ($branch) {
                ...
                if (!isset($branch['children'])) {
                    $uri = url()->isValidUrl($branch['uri']) ? $branch['uri'] : bob_admin_base_path($branch['uri'], 'merchant-admin');
    ...
    public function form()
    {
        ...
        return Form::make(MerchantMenu::with($relations), function (Form $form) use ($menuModel) {
            ...
            $response = $form->response()->location('merchant/auth/menu');
    ...
    {
        return config('merchant-admin.database.menu_model');
    }
}
