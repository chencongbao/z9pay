...
class PermissionController extends AdminController
{
    ...
    public function form()
    {
        ...
        $translateMenuTitle = function ($title): string {
        ...
        return Form::make(Permission::with($with), function (Form $form) use ($bindMenu, $translateMenuTitle) {
            ...
            if ($bindMenu) {
                $form->tree('menus', trans('admin.menu'))
                    ...
                    ->nodes(function () use ($translateMenuTitle) {
                        $model = config('admin.database.menu_model');

                        return (new $model())->allNodes()->transform(function ($item) use ($translateMenuTitle) {
                            $item->title = $translateMenuTitle($item->title);
