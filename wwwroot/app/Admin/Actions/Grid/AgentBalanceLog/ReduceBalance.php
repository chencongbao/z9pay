...
use App\Admin\Forms\AgentBalanceLog\ReduceBalance as ReduceBalanceForm;

class ReduceBalance extends RowAction
{
    protected $title = '代理资金减项';
    ...
    {
        $form = ReduceBalanceForm::make()->payload(['id' => $this->getKey(), 'agent_id' => $this->agent_id]);
