...
namespace App\Admin\Metrics\AgentAdmin\SettlementOrder;
...
class Card1 extends AdminCard
{
    ...
    {
        $model = App::make(ModelQueryService::class)->excute(new TransferOrder(),['status'=>4,'type'=>1,'merchant_agent_id'=>Admin::user()->id]);
