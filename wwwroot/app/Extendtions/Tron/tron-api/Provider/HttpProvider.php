...
use GuzzleHttp\{HandlerStack, Middleware, Psr7\Request, Client, ClientInterface};
...
//                new Logger('guzzle', [new StreamHandler(storage_path('logs/guzzle.log'))]),
//                new \GuzzleHttp\MessageFormatter('{method} {uri} {http_code}  {req_headers} {request}')
//            ));
