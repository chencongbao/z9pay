...
class BatchMerchantReportRepairCommand extends Command
{
    protected $signature = 'report:repair-batch-merchant {date : 统计日期，格式 YYYY-MM-DD}';

    protected $description = '批量修复指定日期的商户报表统计';
    ...
    public function handle(): int
    {
        ...
        $this->info("批量商户报表已加入待重建队列，日期：{$date}");
