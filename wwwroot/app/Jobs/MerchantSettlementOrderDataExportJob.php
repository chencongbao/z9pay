...
class MerchantSettlementOrderDataExportJob implements ShouldQueue
{
    ...
    {
        $this->data = $data;
        $this->cache_key = CacheConstPrefixService::MERCHANT_SETTLEMENT_ORDER_EXPORT_HAS_EXIST . ($this->data['admin_id'] ?? 0);
    }
    ...
    public function handle()
    {
        ...
        $exportType = 'merchant_settlement_orders';
        ...
        $type = "merchant_settlement_orders";
