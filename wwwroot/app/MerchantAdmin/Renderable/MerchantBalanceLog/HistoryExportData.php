...
namespace App\MerchantAdmin\Renderable\MerchantBalanceLog;
...
class HistoryExportData extends LazyRenderable
{
    public function render()
    {
        ...
        $data = app(MerchantExportFileService::class)->historyRows('merchant_merchant_balance_logs', (int)Admin::user()->id);
