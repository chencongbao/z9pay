...
namespace App\MerchantAdmin\Renderable\SettlementOrder;
...
class HistoryExportData extends LazyRenderable
{
    public function render()
    {
        ...
        $data = app(MerchantExportFileService::class)->historyRows('merchant_settlement_orders', (int)Admin::user()->id);
