...
class LookSecrectDetail extends Form implements LazyRenderable
{
    use LazyWidget;
    ...
    public function handle(array $input)
    {
        try {
            ...
            app(MerchantSecretAdminNoticeService::class)->send('查看并重置appkey', $merchantUserId, $appkey);
            ...
            app(SystemLogService::class)->logAction(
                actionKey: 'merchant.secret.view_reset',
                text: '查看并重置 API密钥信息',
                subject: Admin::user(),
                properties: ['merchant_user_id' => $merchantUserId],
                remark: '查看密钥时自动重置 API密钥信息',
                logType: 'operation',
                actionMethod: 'PUT',
                appType: 'merchant',
                user: Admin::user()
